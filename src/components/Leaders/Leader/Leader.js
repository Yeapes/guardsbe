...
const Leader = ({
  ...
  return (
    <div className="relative leader-item" data-aos="fade-left">
      <Image
        className="grayscale-100 hover:grayscale-0 object-cover w-full min-h-[350px] max-h-[350px] object-top"
        src={imageUrl}
        height={350}
        width={300}
        alt={name}
      ...
      <div className="details absolute bottom-10 z-1">
        <div className="leader-details ps-8 relative z-10">
          <h2
            style={{}}
            className="text-2xl xl:text-3xl text-black font-semibold name"
          >
            {name}
          </h2>
